<?php /* Smarty version Smarty-3.1.19, created on 2018-03-01 17:52:48
         compiled from "/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/dashboard/helpers/view/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6197189165a982fe0e47557-30225767%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e339d65ac01022b7cbe43059cc3d7673f6b38d9b' => 
    array (
      0 => '/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/dashboard/helpers/view/view.tpl',
      1 => 1493212360,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6197189165a982fe0e47557-30225767',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a982fe0ebfd67_34190894',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a982fe0ebfd67_34190894')) {function content_5a982fe0ebfd67_34190894($_smarty_tpl) {?>
<script>
...
<?php }?>
			<div id="calendar" class="panel">
				<form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['action']->value);?>
...
">
					...
					<input type="hidden" name="datepickerFrom" id="datepickerFrom" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['date_from']->value);?>
" class="form-control">
					<input type="hidden" name="datepickerTo" id="datepickerTo" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['date_to']->value);?>
" class="form-control">
					...
					<div class="form-group pull-right">
						<button id="datepickerExpand" class="btn btn-default" type="button">
							...
							<span class="hidden-xs">
								...
								<strong class="text-info" id="datepicker-from-info"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['date_from']->value);?>
</strong>
								<?php echo smartyTranslate(array('s'=>'To'),$_smarty_tpl);?>

								<strong class="text-info" id="datepicker-to-info"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['date_to']->value);?>
</strong>
...
&amp;utm_content=<?php if ($_smarty_tpl->tpl_vars['host_mode']->value) {?>cloud<?php } else { ?>download<?php }?>" class="_blank">
		...
		<div class="col-md-12 col-lg-2">
			...
			<section id="dash_version" class="visible-lg">
				<iframe style="overflow:hidden;border:none" src="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['new_version_url']->value,'html','UTF-8');?>
" ></iframe>
			</section>
