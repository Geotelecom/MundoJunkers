<?php /* Smarty version Smarty-3.1.19, created on 2018-03-03 12:48:12
         compiled from "/var/www/vhosts/mundojunkers.es/httpdocs/themes/modez/address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5128524065a9a8b7cd74097-22319024%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '996ee8a237afb9bab79ce4c4a52c84eda11086b0' => 
    array (
      0 => '/var/www/vhosts/mundojunkers.es/httpdocs/themes/modez/address.tpl',
      1 => 1493215137,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5128524065a9a8b7cd74097-22319024',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a9a8b7cf10dc6_44804548',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a9a8b7cf10dc6_44804548')) {function content_5a9a8b7cf10dc6_44804548($_smarty_tpl) {?>
...
"
			<?php } else { ?>
				<?php if (isset($_smarty_tpl->tpl_vars['address']->value->alias)) {?>"<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['address']->value->alias,'html','UTF-8');?>
"<?php }?>
			<?php }?>
		<?php } else { ?>
	...
	<form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true),'html','UTF-8');?>
...
<?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->company)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['address']->value->company,'html','UTF-8');?>
<?php }?><?php }?>" />
				</div>
			<?php }?>
...
<?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->vat_number)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['address']->value->vat_number,'html','UTF-8');?>
<?php }?><?php }?>" />
						</div>
					</div>
				</div>
...
<?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->dni)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['address']->value->dni,'html');?>
<?php }?><?php }?>" />
...
<?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->firstname)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['address']->value->firstname,'html','UTF-8');?>
<?php }?><?php }?>" />
				</div>
			<?php }?>
...
<?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->lastname)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['address']->value->lastname,'html','UTF-8');?>
<?php }?><?php }?>" />
				</div>
			<?php }?>
...
<?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->address1)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['address']->value->address1,'html','UTF-8');?>
<?php }?><?php }?>" />
				</div>
			<?php }?>
...
<?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->address2)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['address']->value->address2,'html','UTF-8');?>
<?php }?><?php }?>" />
				</div>
			<?php }?>
...
<?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->postcode)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['address']->value->postcode,'html','UTF-8');?>
<?php }?><?php }?>" />
				</div>
			<?php }?>
...
<?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->city)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['address']->value->city,'html','UTF-8');?>
...
<?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->phone)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['address']->value->phone,'html','UTF-8');?>
<?php }?><?php }?>"  />
				</div>
...
<?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->phone_mobile)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['address']->value->phone_mobile,'html','UTF-8');?>
<?php }?><?php }?>" />
				</div>
			<?php }?>
		<?php } ?>
...
<?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->other)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['address']->value->other,'html','UTF-8');?>
<?php }?><?php }?></textarea>
		</div>
...
<?php } elseif (isset($_smarty_tpl->tpl_vars['address']->value->alias)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['address']->value->alias,'html','UTF-8');?>
