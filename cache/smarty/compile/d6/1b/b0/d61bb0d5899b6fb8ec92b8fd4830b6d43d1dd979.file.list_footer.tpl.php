<?php /* Smarty version Smarty-3.1.19, created on 2018-03-02 10:14:32
         compiled from "/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/products/helpers/list/list_footer.tpl" */ ?>
<?php /*%%SmartyHeaderCode:710648625a9915f87151e7-04339566%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd61bb0d5899b6fb8ec92b8fd4830b6d43d1dd979' => 
    array (
      0 => '/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/products/helpers/list/list_footer.tpl',
      1 => 1493212374,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '710648625a9915f87151e7-04339566',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a9915f88b43c4_07961515',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a9915f88b43c4_07961515')) {function content_5a9915f88b43c4_07961515($_smarty_tpl) {?>
	</table>
</div>
<div class="row">
	<div class="col-lg-6">
...
"></i><?php }?>&nbsp;<?php echo $_smarty_tpl->tpl_vars['params']->value['text'];?>
				...
				<?php } ?>
				<li>
					<?php  $_smarty_tpl->tpl_vars['langg'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['langg']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['languages']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['langg']->key => $_smarty_tpl->tpl_vars['langg']->value) {
$_smarty_tpl->tpl_vars['langg']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['langg']->key;
?>
					<a href="#" onclick="javascript:if (confirm('¿Quiere exportar los elementos seleccionados?'))sendBulkAction($(this).closest('form').get(0), 'exporta=1&explang=<?php echo $_smarty_tpl->tpl_vars['langg']->value['id_lang'];?>
');">
						<i class="icon-arrow-circle-down"></i>&nbsp;<?php echo smartyTranslate(array('s'=>'Exportar productos'),$_smarty_tpl);?>
: <?php echo $_smarty_tpl->tpl_vars['langg']->value['name'];?>
...
<?php if (!$_smarty_tpl->tpl_vars['simple_header']->value) {?>
		<input type="hidden" name="token" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['token']->value,'html','UTF-8');?>
" />
	</div>
<?php } else { ?>
	</div>
