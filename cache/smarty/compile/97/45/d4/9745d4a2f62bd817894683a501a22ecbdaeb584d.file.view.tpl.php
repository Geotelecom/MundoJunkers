<?php /* Smarty version Smarty-3.1.19, created on 2018-03-01 17:17:42
         compiled from "/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/customer_threads/helpers/view/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1178706135a9827a6790489-39442491%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9745d4a2f62bd817894683a501a22ecbdaeb584d' => 
    array (
      0 => '/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/customer_threads/helpers/view/view.tpl',
      1 => 1493212358,
      2 => 'file',
    ),
    ...
    'f4510e3935b3dd3b040451cd0f3cb8cb8ab77da5' => 
    array (
      0 => '/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/customer_threads/helpers/view/modal.tpl',
      1 => 1493212358,
      2 => 'file',
    ),
    '3f028ca1a36e1ef3268d1ed7a11096ebb258924f' => 
    array (
      0 => '/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/customer_threads/helpers/view/message.tpl',
      1 => 1493212358,
      2 => 'file',
    ),
    '6c760ca3e736cc8d4f26b9e8c9b4354c0293bdda' => 
    array (
      0 => '/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/customer_threads/helpers/view/timeline_item.tpl',
      1 => 1493212358,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1178706135a9827a6790489-39442491',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a9827a68cc841_42856284',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a9827a68cc841_42856284')) {function content_5a9827a68cc841_42856284($_smarty_tpl) {?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("./modal.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '1178706135a9827a6790489-39442491');
content_5a9827a67c1b66_40688548($_smarty_tpl);
...
: <span class="badge">#<?php echo intval($_smarty_tpl->tpl_vars['id_customer_thread']->value);?>
		...
		<?php if (isset($_smarty_tpl->tpl_vars['next_thread']->value)&&$_smarty_tpl->tpl_vars['next_thread']->value) {?>
			<a class="btn btn-default pull-right" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['next_thread']->value['href'],'html','UTF-8');?>
">
 ...
 <i class="icon-forward"></i>
	...
	<div class="well">
		<form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCustomerThreads'),'html','UTF-8');?>
...
?>
				<button class="btn btn-default" name="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['action']->value['name'],'html','UTF-8');?>
" value="<?php echo intval($_smarty_tpl->tpl_vars['action']->value['value']);?>
">
					<?php if (isset($_smarty_tpl->tpl_vars['action']->value['icon'])) {?><i class="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['action']->value['icon'],'html','UTF-8');?>
"></i><?php }?><?php echo $_smarty_tpl->tpl_vars['action']->value['label'];?>
	...
	<div class="row">
		<div class="message-item-initial media">
			<a href="<?php if (isset($_smarty_tpl->tpl_vars['customer']->value->id)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCustomers'),'html','UTF-8');?>
			...
			<div class="media-body">
				<div class="row">
					...
					<?php if (isset($_smarty_tpl->tpl_vars['customer']->value->firstname)) {?>
						<h2>
							<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCustomers'),'html','UTF-8');?>
&amp;id_customer=<?php echo intval($_smarty_tpl->tpl_vars['customer']->value->id);?>
&amp;viewcustomer&">
							<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['customer']->value->firstname,'html','UTF-8');?>
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['customer']->value->lastname,'html','UTF-8');?>
 <small>(<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['customer']->value->email,'html','UTF-8');?>
)</small>
							</a>
						</h2>
					<?php } else { ?>
						<h2><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['thread']->value->email,'html','UTF-8');?>
</h2>
					<?php }?>
 ...
 </span><span class="badge"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['contact']->value,'html','UTF-8');?>
</span>
					<?php }?>
					</div>
					<?php if (isset($_smarty_tpl->tpl_vars['customer']->value->firstname)) {?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("./message.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('message'=>$_smarty_tpl->tpl_vars['first_message']->value,'initial'=>true), 0, '1178706135a9827a6790489-39442491');
content_5a9827a6841b26_92788051($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
?>
			<?php /*  Call merged included template "./message.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("./message.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('message'=>$_smarty_tpl->tpl_vars['message']->value,'initial'=>false), 0, '1178706135a9827a6790489-39442491');
content_5a9827a6841b26_92788051($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
/*  End of included template "./message.tpl" */?>
		<?php } ?>
...
&amp;viewcustomer_thread" method="post" enctype="multipart/form-data" class="form-horizontal">
 ...
 <?php if (isset($_smarty_tpl->tpl_vars['customer']->value->firstname)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['customer']->value->firstname,'html','UTF-8');?>
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['customer']->value->lastname,'html','UTF-8');?>
...
" alt=""><?php }?></span>
			...
			<div class="media-body">
				<textarea cols="30" rows="7" name="reply_message"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['PS_CUSTOMER_SERVICE_SIGNATURE']->value,'html','UTF-8');?>
</textarea>
			</div>
		</div>
	</div>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("controllers/customer_threads/helpers/view/timeline_item.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('timeline_item'=>$_smarty_tpl->tpl_vars['timeline_item']->value), 0, '1178706135a9827a6790489-39442491');
content_5a9827a6897420_29691420($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2018-03-01 17:17:42
         compiled from "/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/customer_threads/helpers/view/modal.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5a9827a67c1b66_40688548')) {function content_5a9827a67c1b66_40688548($_smarty_tpl) {?>
<form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCustomerThreads'),'html','UTF-8');?>
&amp;viewcustomer_thread&amp;id_customer_thread=<?php echo intval($_smarty_tpl->tpl_vars['id_customer_thread']->value);?>
" method="post" enctype="multipart/form-data" class="form-horizontal">
...
<?php /* Smarty version Smarty-3.1.19, created on 2018-03-01 17:17:42
         compiled from "/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/customer_threads/helpers/view/message.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5a9827a6841b26_92788051')) {function content_5a9827a6841b26_92788051($_smarty_tpl) {?>
...
" alt="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['current_employee']->value->firstname,'html','UTF-8');?>
" /><?php }?>
			<?php }?>
		</div>
	</div>
<?php }?>
		...
		<?php if (!$_smarty_tpl->tpl_vars['initial']->value) {?>
			<h4 class="message-item-heading">
				<i class="icon-mail-reply text-muted"></i>
					<?php if ($_smarty_tpl->tpl_vars['type']->value=='customer') {?>
						<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['message']->value['customer_name'],'html','UTF-8');?>

					<?php } else { ?>
						<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['message']->value['employee_name'],'html','UTF-8');?>
 ...
 - <i class="icon-time"></i> <?php echo substr($_smarty_tpl->tpl_vars['message']->value['date_add'],11,5);?>
		...
		<?php if (isset($_smarty_tpl->tpl_vars['message']->value['file_name'])) {?> <span class="message-product">&nbsp;<i class="icon-link"></i> <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['message']->value['file_name'],'html','UTF-8');?>
" class="_blank"><?php echo smartyTranslate(array('s'=>"Attachment"),$_smarty_tpl);?>
</a></span><?php }?>
		<?php if (isset($_smarty_tpl->tpl_vars['message']->value['product_name'])) {?> <span class="message-attachment">&nbsp;<i class="icon-book"></i> <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['message']->value['product_link'],'html','UTF-8');?>
" class="_blank"><?php echo smartyTranslate(array('s'=>"Product:"),$_smarty_tpl);?>
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['message']->value['product_name'],'html','UTF-8');?>
 </a></span><?php }?>
		<p class="message-item-text"><?php echo nl2br($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['message']->value['message'],'html','UTF-8'));?>
</p>
	</div>
</div>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2018-03-01 17:17:42
         compiled from "/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/customer_threads/helpers/view/timeline_item.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5a9827a6897420_29691420')) {function content_5a9827a6897420_29691420($_smarty_tpl) {?>
...
">
			<span class="timeline-icon" style="background-color:<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['timeline_item']->value['background_color'],'html','UTF-8');?>
;">
...
<?php echo intval($_smarty_tpl->tpl_vars['timeline_item']->value['id_order']);?>
			...
			<?php if (isset($_smarty_tpl->tpl_vars['timeline_item']->value['see_more_link'])) {?>
				<br/><br/><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['timeline_item']->value['see_more_link'],'html','UTF-8');?>
