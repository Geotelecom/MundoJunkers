<?php /* Smarty version Smarty-3.1.19, created on 2018-03-06 11:48:38
         compiled from "/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/products/prices.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10593569355a9e72067fbe29-36405559%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1695c8caa95c49fa7b36f6f3cc9a066826932bfe' => 
    array (
      0 => '/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/products/prices.tpl',
      1 => 1493212297,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10593569355a9e72067fbe29-36405559',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a9e720693b205_81650967',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a9e720693b205_81650967')) {function content_5a9e720693b205_81650967($_smarty_tpl) {?>
...
function finan() {
	//var primercalcul = parseFloat($('#tant_percent').val()) * parseFloat($('#priceTI').val().replace(/,/g, '.'));
	//console.log(primercalcul);
	
	//var segoncalcul = parseFloat($('#priceTI').val().replace(/,/g, '.')) - primercalcul;
	var segoncalcul = parseFloat($('#priceTI').val().replace(/,/g, '.'));
	//console.log(segoncalcul);

	var preu = parseFloat(segoncalcul) / parseInt(document.getElementById('financia_mesos').value);
	//console.log(preu);

	//console.log(preu);
	$('#financia_price').val(preu.toFixed(6));
...
" <?php if ($_smarty_tpl->tpl_vars['product']->value->getIdTaxRulesGroup()==$_smarty_tpl->tpl_vars['tax_rules_group']->value['id_tax_rules_group']) {?>selected="selected"<?php }?> >
				...
				<div class="col-lg-2">
					<a class="btn btn-link confirm_leave" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminTaxRulesGroup'),'html','UTF-8');?>
	...
	<div class="form-group">
		<div class="col-lg-9 col-lg-offset-3">
			<div class="alert">
				...
				<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminTaxes'),'html','UTF-8');?>
...
<div class="panel">
	<h3><?php echo smartyTranslate(array('s'=>'Financiación'),$_smarty_tpl);?>
</h3>
	<div class="form-group">
		<label class="control-label col-lg-3" for="financiacion">
			<span class="label-tooltip"><?php echo smartyTranslate(array('s'=>'Mostrar financiación'),$_smarty_tpl);?>
</span>
		</label>
		<div class="col-lg-4">
			<input type="checkbox" id="financiacion" name="financiacion"  value="1" <?php if ($_smarty_tpl->tpl_vars['product']->value->financiacion) {?>checked="checked"<?php }?>  />

		</div>

	</div>
	<div class="form-group">
		<label class="control-label col-lg-3" for="financia_interes">
			<span class="label-tooltip" data-toggle="tooltip" title="<?php echo smartyTranslate(array('s'=>'Interés %'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Interés Apertura'),$_smarty_tpl);?>
</span>
		</label>
		<div class="col-lg-4">
			<div class="input-group">
				
				<input id="financia_interes" name="financia_interes" type="text" value="<?php if (!$_smarty_tpl->tpl_vars['product']->value->financia_interes) {?>3<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['product']->value->financia_interes;?>
<?php }?>" maxlength="3" /> <span class="input-group-addon">%</span>
			</div>
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-lg-3" for="financia_price">
			<span class="label-tooltip" data-toggle="tooltip" title="<?php echo smartyTranslate(array('s'=>'asdf'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Precio / meses'),$_smarty_tpl);?>
</span>
		</label>
		<div class="col-lg-4">
			<div class="input-group">
...
<?php echo $_smarty_tpl->tpl_vars['currency']->value->suffix;?>
				...
				<input id="financia_price" name="financia_price" type="text" value="<?php if (!$_smarty_tpl->tpl_vars['product']->value->financia_price) {?>0<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['product']->value->financia_price;?>
<?php }?>" maxlength="27" />
				<span class="input-group-addon"><?php echo smartyTranslate(array('s'=>'por'),$_smarty_tpl);?>
</span>
				<input id="financia_mesos" name="financia_mesos" type="text" value="<?php if (!$_smarty_tpl->tpl_vars['product']->value->financia_mesos) {?>15<?php } else { ?><?php echo smarty_modifier_htmlentitiesUTF8($_smarty_tpl->tpl_vars['product']->value->financia_mesos);?>
<?php }?>"/>
				<span class="input-group-addon"><?php echo smartyTranslate(array('s'=>'meses'),$_smarty_tpl);?>
</span>
				...
				<p style="text-align: center;"><input type="button" onclick="finan();" value="<?php echo smartyTranslate(array('s'=>'Calcula financiación'),$_smarty_tpl);?>
" class="btn btn-default" /><br/><?php echo smartyTranslate(array('s'=>'Al hacer click se calcula el precio de financiación PRECIO PRODUCTO dividido entre los X MESES'),$_smarty_tpl);?>
</p>
...
" />
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<select name="sp_reduction_type" id="sp_reduction_type">
								<option value="amount" selected="selected"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['currency']->value->name,'html','UTF-8');?>
</option>
	...
	<script type="text/javascript">
		var currencyName = '<?php echo addcslashes($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['currency']->value->name,'html','UTF-8'),'\'');?>
';
		$(document).ready(function(){
