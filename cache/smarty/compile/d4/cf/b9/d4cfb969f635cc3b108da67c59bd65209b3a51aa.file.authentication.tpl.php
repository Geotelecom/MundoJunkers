<?php /* Smarty version Smarty-3.1.19, created on 2018-03-02 02:20:11
         compiled from "/var/www/vhosts/mundojunkers.es/httpdocs/themes/modez/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18161342655a98a6cbdb74f6-45496341%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd4cfb969f635cc3b108da67c59bd65209b3a51aa' => 
    array (
      0 => '/var/www/vhosts/mundojunkers.es/httpdocs/themes/modez/authentication.tpl',
      1 => 1493215137,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18161342655a98a6cbdb74f6-45496341',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a98a6cc1282b2_81141777',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a98a6cc1282b2_81141777')) {function content_5a98a6cc1282b2_81141777($_smarty_tpl) {?>
...
" rel="follow" title="<?php echo smartyTranslate(array('s'=>'Authentication'),$_smarty_tpl);?>
...
?>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6">
			<form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true),'html','UTF-8');?>
...
<?php }?>" /></span>
					...
					<p class="lost_password form-group"><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['link']->value->getPageLink('password'),'html','UTF-8');?>
" title="<?php echo smartyTranslate(array('s'=>'Recover your forgotten password'),$_smarty_tpl);?>
" rel="follow"><?php echo smartyTranslate(array('s'=>'Forgot your password?'),$_smarty_tpl);?>
</a></p>
					<p class="submit">
						<?php if (isset($_smarty_tpl->tpl_vars['back']->value)) {?><input type="hidden" class="hidden" name="back" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['back']->value,'html','UTF-8');?>
" /><?php }?>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['inOrderProcess']->value)&&$_smarty_tpl->tpl_vars['inOrderProcess']->value&&$_smarty_tpl->tpl_vars['PS_GUEST_CHECKOUT_ENABLED']->value) {?>
		<form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back']->value)),'html','UTF-8');?>
...
?>
								<option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id_country'];?>
"<?php if ((isset($_smarty_tpl->tpl_vars['guestInformations']->value)&&$_smarty_tpl->tpl_vars['guestInformations']->value['id_country_invoice']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_smarty_tpl->tpl_vars['guestInformations']->value)&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])) {?> selected="selected"<?php }?>><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['v']->value['name'],'html','UTF-8');?>
</option>
								<?php } ?>
							</select>
						</div>
