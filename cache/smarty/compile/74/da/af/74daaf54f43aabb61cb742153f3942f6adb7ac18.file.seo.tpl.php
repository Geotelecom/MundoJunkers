<?php /* Smarty version Smarty-3.1.19, created on 2018-03-06 11:48:39
         compiled from "/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/products/seo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12348812305a9e72078fd528-71727189%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '74daaf54f43aabb61cb742153f3942f6adb7ac18' => 
    array (
      0 => '/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/products/seo.tpl',
      1 => 1493212297,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12348812305a9e72078fd528-71727189',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a9e720796a729_65120951',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a9e720796a729_65120951')) {function content_5a9e720796a729_65120951($_smarty_tpl) {?>
...
<br/>
				<strong><?php if (isset($_smarty_tpl->tpl_vars['rewritten_links']->value[$_smarty_tpl->tpl_vars['language']->value['id_lang']][0])) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['rewritten_links']->value[$_smarty_tpl->tpl_vars['language']->value['id_lang']][0],'html','UTF-8');?>
<?php }?><span id="friendly-url_<?php echo $_smarty_tpl->tpl_vars['language']->value['id_lang'];?>
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['product']->value->link_rewrite[$_smarty_tpl->tpl_vars['language']->value['id_lang']],'html','UTF-8');?>
</span><?php if (isset($_smarty_tpl->tpl_vars['rewritten_links']->value[$_smarty_tpl->tpl_vars['language']->value['id_lang']][1])) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['rewritten_links']->value[$_smarty_tpl->tpl_vars['language']->value['id_lang']][1],'html','UTF-8');?>
<?php }?></strong>
			</div>
			<?php } ?>
		</div>
