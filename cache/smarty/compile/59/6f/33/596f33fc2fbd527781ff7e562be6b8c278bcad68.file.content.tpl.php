<?php /* Smarty version Smarty-3.1.19, created on 2018-03-01 18:03:16
         compiled from "/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/login/content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17526683795a983254371278-38078399%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '596f33fc2fbd527781ff7e562be6b8c278bcad68' => 
    array (
      0 => '/var/www/vhosts/mundojunkers.es/httpdocs/backoffice/themes/default/template/controllers/login/content.tpl',
      1 => 1493212287,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17526683795a983254371278-38078399',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a9832543ec991_84235430',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a9832543ec991_84235430')) {function content_5a9832543ec991_84235430($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/vhosts/mundojunkers.es/httpdocs/tools/smarty/plugins/modifier.date_format.php';
?>
<div id="login-panel">
	<div id="login-header">
...
"/>
					<div class="form-group">
						...
						<input name="email" type="email" id="email" class="form-control" value="<?php if (isset($_smarty_tpl->tpl_vars['email']->value)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['email']->value,'html','UTF-8');?>
<?php }?>" autofocus="autofocus" tabindex="1" placeholder="&#xf0e0 test@example.com" />
					...
					<div class="form-group">
						...
						<input name="passwd" type="password" id="passwd" class="form-control" value="<?php if (isset($_smarty_tpl->tpl_vars['password']->value)) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['password']->value,'html','UTF-8');?>
...
" />
		...
		<div class="alert alert-danger">
			...
			<p>
				<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['adminUrl']->value,'html','UTF-8');?>
">
