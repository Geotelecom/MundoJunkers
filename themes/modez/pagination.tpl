...
{if isset($no_follow) AND $no_follow}
	{assign var='no_follow_text' value='rel="follow"'}
{else}
	...
	<div id="pagination{if isset($paginationId)}_{$paginationId}{/if}" class="pagination clearfix">
		...
		{if $start!=$stop}
			<ul class="pagination">
				...
				{if $start==3}
					<li>
						<a {$no_follow_text}  href="{$link->goPage($requestPage, 1)}" rel="prev">
							<span>1</span>
						</a>
					</li>
					<li>
				...
				{section name=pagination start=$start loop=$stop+1 step=1}
					...
					{else}
						<li>
							<a {$no_follow_text} href="{$link->goPage($requestPage, $smarty.section.pagination.index)}" rel="prev">
				...
				{if $pages_nb>$stop+2}
					...
					<li>
						<a href="{$link->goPage($requestPage, $pages_nb)}" rel="next">
				...
				{if $pages_nb==$stop+2}
					<li>
						<a href="{$link->goPage($requestPage, $pages_nb-1)}" rel="next">
