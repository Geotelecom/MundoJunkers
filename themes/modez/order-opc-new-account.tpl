<div id="opc_new_account" class="opc-main-block">
	...
	<h1 class="step-num account">{l s='Account'}</h1>
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box-form">
		<fieldset>
			<p class="text-right "><a href="{$link->getPageLink('authentication', true)|escape:'html'}" id="openLoginFormBlock">{l s='Already registered?'} {l s='Click here'}</a></p>

			<p class="text-right unvisible openChoise"><a href="javascript:void(0)" id="openChoise">{l s='Cambiar tipo de registro'} {l s='Click here'}</a></p>
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
		<fieldset>
			...
			<div id="opc_account_form" class="unvisible">
				...
				<div class="email_param col-md-7 no-padding-left">
				...
				<div class="col-md-5 no-padding is_customer_param">
				...
				<div class="required clearfix gender-line gender_param unvisible">
				...
				<div class="select form-group date-select birth_param unvisible">
				...
				<div class="checkbox optin_param unvisible" >
                	<label for="optin">
				...
				<div class="col-md-{if $postCodeExist}8{else}12{/if} no-padding">
					<div class="required text form-group">
				...
				{/if}
				<div class="form-group is_customer_param other_param unvisible">
