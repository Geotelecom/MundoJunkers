...
<div id="roybrands" class="block">
    ...
    <span class="fletxes">
        <span class="botocarusel" onClick="pasa('ant', '.marquesblock', '#marca_');"><i class="icon-chevron-left" title="{l s='Product Brands' mod='roybrands'} {l s='previous' mod='roybrands'}"></i></span>
        <span class="botocarusel" onClick="pasa('sig', '.marquesblock', '#marca_');"><i class="icon-chevron-right" title="{l s='Product Brands' mod='roybrands'} {l s='next' mod='roybrands'}"></i></span>
    </span>   
    </p>
