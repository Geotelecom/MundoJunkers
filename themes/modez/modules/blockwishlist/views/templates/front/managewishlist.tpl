...
{if $products}
    {if !$refresh}
        ...
        <a id="hideSendWishlist" class="button_account icon"  href="#" onclick="WishlistVisibility('wishlistLinkTop', 'SendWishlist'); return false;" rel="follow" title="{l s='Close send this wishlist' mod='blockwishlist'}">
