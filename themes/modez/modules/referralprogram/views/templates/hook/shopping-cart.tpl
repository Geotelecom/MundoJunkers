...
<p id="referralprogram">
	...
	<a href="{$link->getModuleLink('referralprogram', 'program', [], true)|escape:'html':'UTF-8'}" title="{l s='Referral program' mod='referralprogram'}" rel="follow">{l s='View your referral program.' mod='referralprogram'}</a>
</p>
<br />
