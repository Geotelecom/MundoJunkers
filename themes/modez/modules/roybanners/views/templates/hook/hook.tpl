...
<div id="htmlcontent_{$hook|escape:'htmlall':'UTF-8'}"{if $hook == 'top'} class="col-xs-12 col-md-12"{/if}>
	<ul class="htmlcontent-home clearfix row">
		{foreach name=items from=$htmlitems item=hItem}
			<li class="htmlcontent-item-{$smarty.foreach.items.iteration|escape:'htmlall':'UTF-8'} col-xs-4 bview bview-first">
				{if $hItem.url}
