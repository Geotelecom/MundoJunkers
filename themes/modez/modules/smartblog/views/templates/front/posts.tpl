...
<div id="content">
   <div itemtype="#" itemscope="" id="sdsblogArticle" class="blog-post">
   		<div>
   			<h1 class="page-heading product-listing">{$meta_title}</h1>
   		</div>
      <div class="post-info">
      ...
      <div itemprop="articleBody">
            <div id="lipsum" class="articleContent">
                    ...
                    {if ($post_img != "no" && $activeimgincat == 0) || $activeimgincat == 1}
                        <a id="post_images" href="{$modules_dir}/smartblog/images/{$post_img}-single-default.jpg"><img src="{$modules_dir}/smartblog/images/{$post_img}-single-default.jpg" alt="{$meta_title}" title="{$meta_title}"></a>
                    {/if}
             </div>
...
<div class="smartblogcomments" id="respond">
    ...
    <h4 class="comment-reply-title" id="reply-title">{l s='Leave a Reply'  mod='smartblog'} <small style="float:right;">
                <a style="display: none;" href="/wp/sellya/sellya/this-is-a-post-with-preview-image/#respond" 
                   id="cancel-comment-reply-link" rel="follow">{l s='Cancel Reply'  mod='smartblog'}</a>
            </small>
        </h4>
		<div id="commentInput">
	<table>
	...
	<div class="right">
        ...
        <div class="submit">
            <input type="submit" name="addComment" id="submitComment" class="button btn btn-default button-medium" value="{l s='Enviar' mod='smartblog'}">
		</div>
