...
{else}
	<div id="carrier_area" class="opc-main-block">
		<h1 class="step-num send">{l s='Delivery methods'}</h1>
			<div id="opc_delivery_methods" class="opc-main-block">
				<div id="opc_delivery_methods-overlay" class="opc-overlay" style="display: none;"></div>
{/if}
<div class="order_carrier_content box-form">
		...
		{else}
			...
			<div class="delivery_options_address">
				...
				<div id="extra_carrier" style="display: none;"></div>
					{if $giftAllowed}
					<div class="col-md-12">
						<p class="carrier_title"><a href="#" class="gift_link">{l s='Gift'}</a></p>
						<div class="gift_param unvisible">
			...
			{if $opc}
			<div class="col-md-12">
				<p class="carrier_title"><a href="#" class="message_link">{l s='Leave a message'}</a></p>
	 			<div class="message_param unvisible">
			...
			{*if $conditions AND $cms_id}
				...
				<p class="checkbox">
					...
					<a href="{$link_conditions|escape:'html':'UTF-8'}" class="iframe" rel="follow">{l s='(Read the Terms of Service)'}</a>
				</p>
			{/if*}
		</div> <!-- end delivery_options_address -->
		{if !$opc}
				<p class="cart_navigation_ clearfix">
