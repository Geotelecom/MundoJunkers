...
class filesHandler
{
    ...
    {
        $bg = (empty($settings['tab_background_link'][$id_lang])) ? 'background-color: ' . $settings['tab_wrapper_bg_color'] . ';' :  'background-image: url(' . $settings['tab_background_link'][$id_lang] . ');';
    ...
    public static function generateCSS($desktop_menu_settings, $mobile_menu_settings, $path)
    {
        ...
        $basic_style = "
            ...
            #FINALmenu #FINALmenu-desktop-nav > li:hover .top-link-wrapper span {
                color: {$desktop_menu_settings['foreground_hover_color']};
            }
    ...
    public static function appendCSS($settings, $path)
    {
        ...
        $output = "
            ...
            #FINALmenu-vertical #FINALmenu-vertical-nav > li:hover .top-link-wrapper span {
                color: {$settings['foreground_hover_color']};
            }
    ...
    {
        $output = '
            window.menuAnimateInVertical = "'.$settings['menuAnimateIn'].'";
