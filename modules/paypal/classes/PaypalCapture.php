...
class PaypalCapture extends ObjectModel
{
	...
	public function getRestToPaid(Order $order)
	{
		...
		$totalPaid = Tools::ps_round($cart->getOrderTotal() + $order->payment_fee, 2);
	...
	public function getRestToCapture($id_order)
	{
		...
		$total = Tools::ps_round($cart->getOrderTotal() - $order->payment_fee, 2) - Tools::ps_round(self::getTotalAmountCapturedByIdOrder($id_order), 2);
