	...
	<tr>
		...
		<td style="width: 85%; text-align: right">
			...
			<table style="width: 100%">
				...
				<tr style="line-height:5px;">
					<td style="width: 85%; text-align: right; font-weight: bold;">{l s='Administration fees' pdf='true'}</td>
					<td style="width: 15%; text-align: right;">{if $tax_excluded_display}- {displayPrice currency=$order->id_currency price=($order->payment_fee / (1+($order->payment_fee_rate/100)))}{else}- {displayPrice currency=$order->id_currency price=$order->payment_fee}{/if}</td>
				</tr>
				{/if}
