...
class smartblog extends Module {
    ...
    public function install(){
            Configuration::updateGlobalValue('smartpostperpage', '4');
    ...
    public function hookModuleRoutes($params) {
	    ...
	    'smartblog_precategory' => array(
                'controller' => 'preprocess',
                'rule' =>       $alias.'/category/{slug}/',
                'keywords' => array(
                    'slug'       =>   array('regexp' => '[_a-zA-Z0-9-\pL]*', 'param' => 'blog_rewrite'),
                ),
                'params' => array(
                    'fc' => 'module',
                    'module' => 'smartblog',
	    ...
	    'smartblog_prepage' => array(
                'controller' => 'preprocess',
                'rule' =>       $alias.'/page/{slug}/',
                'keywords' => array(
                    'slug'       =>   array('regexp' => '[_a-zA-Z0-9-\pL]*', 'param' => 'blog_rewrite'),
                ),
                'params' => array(
...
<script type="text/javascript">
    ...
    public function SettingForm() {
        $blog_url = smartblog::GetSmartBlogLink('blog');
        $img_desc = '';
    ...
    public function SampleDataInstall()  {
         ...
         $languages = Language::getLanguages(false);
                for ($i = 1; $i <= 4; $i++){
                    ...
                    elseif($i==2):
                        $title='Best Bag of Summer';
                       $slug='bestbag';
                    $des='Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.';
                    elseif($i==3):
                          $title='New York Trends';
                          $slug='newyork';
                    $des='Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.';
                    elseif($i==4):
    ...
    public static function GetSmartBlogLink($rewrite = 'blog',$params = null, $id_shop = null,$id_lang = null){
