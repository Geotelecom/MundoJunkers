...
class BlockBestSellers extends Module
{
	...
	public function hookDisplayHomeTab($params)
	{
		if (!$this->isCached('tab.tpl', $this->getCacheId('blockbestsellers-tab')))
		{
			...
			$category = new Category(138, (int)Context::getContext()->language->id);
			$nb = (int)Configuration::get('HOME_FEATURED_NBR');

			//BlockBestSellers::$cache_best_sellers = $this->getBestSellers($params);
			BlockBestSellers::$cache_best_sellers = $category->getProducts((int)Context::getContext()->language->id, 1, ($nb ? $nb : 8), 'position');
