...
{if $labelpos == 0 || $labelpos == 3}
    <div class="form-group capcha_box">
        ...
        {/if}
    	<div id="{$idatt|escape:'html':'UTF-8'}" class="g-recaptcha" data-sitekey="{l s='{$sitekey|escape:\'html\':\'UTF-8\'}' mod='gformbuilderpro'}" style="transform:scale(0.77);-webkit-transform:scale(0.77);transform-origin:0 0;-webkit-transform-origin:0 0;"></div>
