...
<table style="width:100%;">
    ...
    <tr>
		<td colspan="2" align="center" class="logo" style="border-bottom:4px solid #333333;padding:7px 0;">
			<a title="{shop_name}" href="{shop_url}" style="color:#337ff1">
				<img src="{/literal}{$shop_logo|escape:'html':'UTF-8'}{literal}" alt="{shop_name}" />
			</a>
		</td>
	</tr>
    <tr>
    ...
    <tr>
        <td colspan="2" style="border-top:4px solid #333333;text-align:center;">
            <a href="{$shopurl|escape:'html':'UTF-8'}" title="{$shopname|escape:'html':'UTF-8'}">{$shopname|escape:'html':'UTF-8'}</a>
        </td>
    </tr>
</table>