	...
	{if $input.type == 'formbuilder'}
        ...
        <div  class="col-lg-12">
            <div class="row">
                ...
                <textarea class="hidden" name="formtemplate" id="formbuilder_content">{if isset($fields_value['formtemplate'])}{$fields_value['formtemplate']}{/if}</textarea>{* $fields_value['formtemplate'] is html content, no need to escape*}
