...
class gformrequestModel extends ObjectModel
{
    ...
    public static function getExportData($id_form=0,$id_shop=0,$from='',$to=''){
        $sql = 'SELECT a.*,c.id_shop FROM '._DB_PREFIX_.'gformrequest as a, '._DB_PREFIX_.'gformrequest_shop as c WHERE a.id_gformrequest = c.id_gformrequest';
