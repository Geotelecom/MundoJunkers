...
class RoyFacebookBlock extends Module
{
	public function __construct()
	{
		$this->name = 'royfacebookblock';
		...
		$this->bootstrap = true;
		parent::__construct();
		$this->displayName = $this->l('Roy Facebook block');
		$this->description = $this->l('Displays floating block for subscribing to your Facebook page.');
	...
	public function install()
	{
		return parent::install() &&
			...
			$this->registerHook('displayFixed') &&
	...
	public function getContent()
	{
		...
		if (Tools::isSubmit('submitModule'))
		{
			...
			$this->_clearCache('royfacebookblock.tpl');
		...
		$this->context->smarty->assign('facebook_js_url', $this->_path.'royfacebookblock.js');
		$this->context->smarty->assign('facebook_css_url', $this->_path.'css/royfacebookblock.css');
		$html .= $this->context->smarty->fetch($this->local_path.'views/admin/_configure/preview.tpl');
		return $html;
	}

	public function hookDisplayFixed()
	{
		if (!$this->isCached('royfacebookblock.tpl', $this->getCacheId()))
		{
			$facebookurl = Configuration::get('blockfacebook_url');
		...
		return $this->display(__FILE__, 'royfacebookblock.tpl', $this->getCacheId());
	}

	public function hookHeader()
	{
		$this->page_name = Dispatcher::getInstance()->getController();
			$this->context->controller->addCss(($this->_path).'css/royfacebookblock.css');
			$this->context->controller->addJS(($this->_path).'royfacebookblock.js');
	}
