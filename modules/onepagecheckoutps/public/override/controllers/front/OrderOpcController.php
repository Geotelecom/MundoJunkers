...
class OrderOpcController extends OrderOpcControllerCore
{
    ...
    */
    ...
    public function init()
    {
        ...
        if ((Tools::getIsset('rc') || $show_authentication) &&
            !$this->context->customer->isLogged()) {
...
//                            $new_field->classes = 'col-xs-12';
            ...
            $id_country_default = FieldClass::getDefaultValue('delivery', 'id_country');
            $iso_code_country_default = Country::getIsoById($id_country_default);
            ...
            $smarty->assign(array(
                ...
                'id_country_delivery_default' => $id_country_default,
                'iso_code_country_delivery_default' => $iso_code_country_default,
