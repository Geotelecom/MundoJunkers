...
$(function () {
    $('#pts_register_product').on('click', '.toggle-form', function() {
        if (!$('#pts_register_product .form-register').is(':visible')) {
            $('#pts_register_product .form-register').hide().removeClass('hidden');
            $('#pts_register_product .form-register').slideDown();
        } else {
            $('#pts_register_product .form-register').slideUp();
        }

        if (!$('#pts_register_product .form-validate').is(':visible')) {
            $('#pts_register_product .form-validate').hide().removeClass('hidden');
            $('#pts_register_product .form-validate').slideDown();
        } else {
...
jQuery.extend({
    ...
    sendRegister: function (e) {
        if (!$.isEmpty($('#txt_email').val()) && !$.isEmpty($('#txt_number_order').val())) {
            $('#frm_register_product').submit();
        } else {
            e.preventDefault();
            e.stopPropagation();
